function createnav() {
  ...
  <div class="container">
        ...
        <ul class="nav-links">
          <li><a href="/c.html/" id="school"><i class="fa-solid fa-gamepad active"></i> Games</a></li>
          <span style="color: var(--Background-Color); opacity: 75%;">|</span>
          <li><a href="/a.html/" id="algebra"><i class="fas fa-shapes active"></i> Apps</a></li>
          <span style="color: var(--Background-Color); opacity: 75%;">|</span>
         <li><a href="/s.html/" id="sett"><i class="fa-solid fa-gear active"></i> Settings</a></li>
          <span style="color: var(--Background-Color); opacity: 75%;">|</span>
         <li><a href="/w.html/" id="brows"><i class="fa-solid fa-search active"></i>Sea<x>rch</a></li>
          <span style="color: var(--Background-Color); opacity: 75%;">|</span>
